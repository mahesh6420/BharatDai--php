    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="breadcrumb-fullscreen-parent phone-menu-bg">
                <div class="breadcrumb breadcrumb-fullscreen alignleft small-description overlay almost-black-overlay" style="background-image: url('assets/img/pricacyback.jpg');" data-stellar-background-ratio="0.5" data-stellar-vertical-offset="0">
                    <div class="breadTxt">
                        <h1>
                           App Privacy Policy 
                        </h1>
                        <p>
                            This page contains the privacy policy of my personal app.
...
<section style="background-image:url(assets/img/policyfade.jpg);" class="biography padding background-properties" id="content">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <p>
                    Mahesh Sunuwar built the Bharat Samari app as a Free app. This SERVICE is provided by Mahesh Sunuwar at no cost and is
    ...
    with anyone except as described in this Privacy Policy.
                ...
                <p>
                    The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Bharat
    Samari unless otherwise defined in this Privacy Policy.
                </p>
                <p>
    ...
    information, including but not limited to Read Phone State, Record Audio. The information that I request is retained
    ...
    Internet Protocol (“IP”) address, device name, operating system version, the configuration of the app when utilizing
